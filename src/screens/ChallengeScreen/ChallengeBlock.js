    ...
    >
      ...
      <View style={{ padding: 25 }}>
        ...
        >
          ...
          <View style={{width: SLIDER_WIDTH, height: 15 , flexDirection: 'row'}}>
            <View style={{width: steps / target * SLIDER_WIDTH, height: '100%', backgroundColor:"#39e75f", borderRadius: 20}}>
            </View>
            <View style={{flex: 1, height: '100%', backgroundColor:'#3c3c46', borderRadius: 20}}>
            </View>
          </View>
          <Image
            source={{
            ...
            style={{
              ...
              left: Math.ceil((steps / target) * SLIDER_WIDTH - THUMB_IMAGE_SIZE / 2),
            }}
          />
        </View>
      </View>
